...
class Paddle(Block):
    ...
    def mouse_controls(self):
        ...
        self.hitbox.centerx = lerp(self.hitbox.centerx, target_x, self.smoothness.x)
    ...
    def update_bounce(self):
        ...
        self.hitbox.y = lerp(self.hitbox.y, self.target_y, self.smoothness.y)
